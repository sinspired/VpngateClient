...
translations = {
    "en": {
        ...
        "vpn_start_running": "\033[2J\033[H\033[32m[VPNGATE-CLIENT] Version: %s\033[0m",
        ...
        "vpn_init_success": "VPN initialized completed! %s (%s)\033[0m \033[90m| %s:%s | %s | time: %s s\033[0m",
        ...
        "next_vpn": "Next VPN...",
        "performing_connect_test": "\033[90mPerforming connection test.\033[0m",
        ...
        "h_arg_only_check_tiktok": "Only check TikTok servers, ignore other errors.",
        # 新增日志相关翻译
    ...
    "zh": {
        ...
        "Released_at": "发布于",
        "vpn_start_running": "\033[2J\033[H\033[32m[VPNGATE 客户端] 版本: %s\033[0m",
        ...
        "vpn_init_success": "\033[32m初始化完成! %s (%s)\033[0m \033[90m| %s:%s | %s | 用时: %s 秒\033[0m",
        "setup_iptables_rules": "设置 iptables 规则以阻止非 VPN 流量",
        "clear_ptables_rules": "清除 iptables 规则",
        "performing_connect_test": "\033[90m检测 VPN 连通性...            \033[0m",
        "performing_speedtest": "\033[90m运行 VPN 下载速度测试，按 CTRL+C 终止测速.\033[0m",
        ...
        "h_arg_sort_latency": "已开启延迟排序, 使用 \033[90m-ns\033[0m 关闭延迟排序",
        "h_arg_no_sort_latency": "关闭延迟排序",
        "h_arg_udp_latency": "为 UDP 协议的 VPN 设置默认延迟（毫秒），用于排序",
        "h_arg_only_check_tiktok": "仅检测 TikTok 服务，忽略其他错误。",
        # 新增日志相关翻译
