...
translations = {
    "en": {
        ...
        "vpn_init_success": "VPN initialized successfully! Country: %s\033[0m \033[90m%s:%s | %s | time: %s s\033[0m",
        ...
        "h_arg_sort_latency": "Sort the available VPN list by latency, specify the parameter \033[90m--no-sort-latency\033[0m to cancel the latency sorting.",
    ...
    "zh": {
        ...
        "vpn_init_success": "\033[32mVPN初始化成功！国家：%s\033[0m \033[90m%s:%s | %s | 用时: %s 秒\033[0m",
        ...
        "setup_finished": "\033[32mVPN 链接设置完成!\033[0m \033[90m(按 CTRL+C 切换下一个 VPN 或结束连接并退出)\033[0m",
        "connection_disconnected": "VPN监测程序发现连接已断开，尝试下一个服务器！",
        ...
        "VPN Connected stable in n minutes, save VPN config in CSV file": "\033[32mVPN 稳定连接 %s 分钟，将 VPN 配置保存到 CSV 文件: \033[90;4m%s\033[0m",
        "(No status change for %s seconds)": "(%s 秒内未检测到数据读写)",
        ...
        "h_arg_sort_latency": "对可用 VPN 列表进行延迟排序, \033[90m--no-sort-latency\033[0m 取消延迟排序",
